    ...
    public class NPCPath : MonoBehaviour
    {
        ...
        public void BuildPath(NPCScheduleEvent npcScheduleEvent)
        {
            ...
            else if (npcScheduleEvent.toSceneName != npcMovement.npcCurrentScene)
            {
                ...
                var sceneRoute = NPCManager.Instance.
                    GetSceneRoute(npcMovement.npcCurrentScene.ToString(), npcScheduleEvent.toSceneName.ToString());
        ...
        public void UpdateTimesOnPath()
        {
            ...
            // Loop through all npc movement step stack and calculate time for each step
            foreach (NPCMovementStep npcMovementStep in npcMovementStepStack)
            {
                ...
                currentGameTime = currentGameTime.Add(movementTimeStep);    // This will be add to next step
        ...
        {
            return (npcMovementStep.gridCoordinate.x != previousNPCMovementStep.gridCoordinate.x) &&
