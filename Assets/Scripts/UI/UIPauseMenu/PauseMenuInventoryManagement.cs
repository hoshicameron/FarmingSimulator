...
namespace UI
{
    public class PauseMenuInventoryManagement : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (InventoryManager.Instance != null)
            {
                PopulatePlayerInventory(InventoryLocation.Player,
                    InventoryManager.Instance.inventoryArrayList[(int)InventoryLocation.Player]);
            }
        }
        ...
        public void DestroyCurrentlyDraggedItems()
        {
            ...
            for (int i = 0; i < InventoryManager.Instance.inventoryArrayList[(int)InventoryLocation.Player].Count; i++)
            {
