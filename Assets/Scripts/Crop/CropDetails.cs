...
namespace Crop
{
    ...
    public class CropDetails
    {
        ...
        public bool disableCropCollidersBeforeHarvestedAnimation;// if collider on crop should be disabled to avoid the harvested animation effecting any other game objects
        ...
        /// <summary>
        /// Return true if the tool item code can be used to harvest this crop, else returns false
        /// </summary>
        /// <param name="toolItemCode"></param>
        /// <returns></returns>
        public bool CanUseToolToHarvestCrop(int toolItemCode)
        {
            if (RequireHarvestActionsForTool(toolItemCode) == -1)
            {
                return false;
            } else
            {
        ...
        /// <param name="toolItemCode"></param>
        /// <returns></returns>
        private int RequireHarvestActionsForTool(int toolItemCode)
        {
